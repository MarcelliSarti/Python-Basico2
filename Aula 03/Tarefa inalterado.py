...
# entre parenteses. Veja o exemplo abaixo. Note que, para uma lista
# li, deve ser chamado print(li).
##
# Crie uma função que mostra o comprimento de uma linha. Veja que,
# para uma linha li, deve ser chamado len(li).
#
#
...
# já implementado na classe linha. Veja exemplo abaixo.
#
